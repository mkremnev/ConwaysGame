...
describe('Testing GameOfLifeWithRedux helpers', () => {
	describe('Testing function gameOflife', () => {
		...
		])('testing logic function gameoflife %#', (a, expected) => {
			expect(gameOflife(a, 3, 3)).toEqual(expected);
		});
	});

	describe('Testing function cellGridFillRandom', () => {
		it('Should generate an array of random values', () => {
